...
import static com.lyentech.bdc.md.auth.common.constant.MdLoginAuthTypeConstant.SIGN;
import static com.lyentech.bdc.md.auth.common.constant.MdLoginAuthTypeConstant.SSO;
import static com.lyentech.bdc.md.auth.common.constant.MdLoginProcessFilterConstant.MD_LOGIN_BODY;

/**
 * @author 260583
 */
public class MdSignAuthenticationProcessingFilter extends UsernamePasswordAuthenticationFilter {
    private boolean postOnly = true;
    private boolean continueChainBeforeSuccessfulAuthentication = false;
    private SessionAuthenticationStrategy sessionStrategy = new NullAuthenticatedSessionStrategy();

    public MdSignAuthenticationProcessingFilter() {
        super();
    }
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        if (SIGN.equals(authType)) {
            ...
            try {
                ...
                throw new MdLoginSignErrorException("回调地址解码失败");
            }
            ...
            MdSignAuthenticationToken authRequest = new MdSignAuthenticationToken(clientId, credential);
