...
import static com.lyentech.bdc.md.auth.common.constant.MdLoginAuthTypeConstant.OUTAUTH;
import static com.lyentech.bdc.md.auth.common.constant.MdLoginAuthTypeConstant.SMSCUS;
import static com.lyentech.bdc.md.auth.common.constant.MdLoginProcessFilterConstant.MD_LOGIN_BODY;

/**
 * @author guolanren
 */
public class MdSmsCusAuthenticationProcessingFilter extends UsernamePasswordAuthenticationFilter {

    private boolean postOnly = true;
    private boolean continueChainBeforeSuccessfulAuthentication = false;
    private SessionAuthenticationStrategy sessionStrategy = new NullAuthenticatedSessionStrategy();

    public MdSmsCusAuthenticationProcessingFilter() {
        super();
    }
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        if (SMSCUS.equals(authType)) {
            ...
            MdSmsCusAuthenticationToken authRequest = new MdSmsCusAuthenticationToken(callback, clientId);
