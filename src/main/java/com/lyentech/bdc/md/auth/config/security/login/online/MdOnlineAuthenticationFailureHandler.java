...
public class MdOnlineAuthenticationFailureHandler implements AuthenticationFailureHandler {

    private final ObjectMapper objectMapper;

    public MdOnlineAuthenticationFailureHandler(ObjectMapper objectMapper) {
