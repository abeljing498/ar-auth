...
public class MdOnlineAuthenticationSuccessHandler implements AuthenticationSuccessHandler {

    private final ObjectMapper objectMapper;
    private final MdLoginLogMapper loginLogMapper;
    private final TokenStore tokenStore;

    public MdOnlineAuthenticationSuccessHandler(ObjectMapper objectMapper, MdLoginLogMapper loginLogMapper, TokenStore tokenStore) {
