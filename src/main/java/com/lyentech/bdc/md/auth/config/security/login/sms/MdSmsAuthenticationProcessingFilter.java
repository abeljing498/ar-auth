...
import static com.lyentech.bdc.md.auth.common.constant.MdAfsConstant.SKIP_AFS;
 ...
 * @author guolanren
 */
public class MdSmsAuthenticationProcessingFilter extends UsernamePasswordAuthenticationFilter {

    private boolean postOnly = true;
    private boolean continueChainBeforeSuccessfulAuthentication = false;
    private SessionAuthenticationStrategy sessionStrategy = new NullAuthenticatedSessionStrategy();

    public MdSmsAuthenticationProcessingFilter() {
        super();
    }
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        if (SMS.equals(authType)) {
           ...
           String userIp= ServletUtil.getClientIP(request);
            MdSmsAuthenticationToken authRequest = new MdSmsAuthenticationToken(phone, smsCode,clientId,loginParam.getLoginSystem(),loginParam.getLoginBrowser(),userIp);
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        try {
            if (continueChainBeforeSuccessfulAuthentication) {
                request.setAttribute(SKIP_AFS, true);
                chain.doFilter(request, response);
            }
        } finally {
            request.removeAttribute(SKIP_AFS);
        }
